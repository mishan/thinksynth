...
/* mixer::mul shipped with this same description and divides its second
   input by full scale first. This one is the plain product. */
static const char desc[] = "Multiplies two streams, unscaled";
