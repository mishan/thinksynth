...
/* One note of a patch, mixed to mono.
   ...
   one the audio thread is running. The synth's plugins are reset first,
   so the noise sources start where they did last time and two renders
   of one patch are the same render.
