/* $Id: thALSAAudio.cpp,v 1.5 2004/01/29 05:56:27 ink Exp $ */
...
void thALSAAudio::SetFormat (const thAudioFmt *afmt)
{
   ...
   switch(ifmt.bits) {
    ...
    snd_pcm_hw_params_set_period_size(play_handle, hw_params, ifmt.period * 1.75, 0); /* where the buffer is actually set. */
