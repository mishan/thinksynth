# $Id: bd7.dsp,v 1.3 2004/02/09 10:50:28 misha Exp $
name "test";
...
node ionode {
	...
	tonemul = 1.02; # How much higher than the last
	tonemuladd = 0.13; # Linear addition to the multiplication variable
...
node tonemulcalc1 math::mul {
	in0 = ionode->tonemul;
	in1 = ionode->tonemuladd;
};

node tonemulcalc2 math::mul {
	in0 = tonemulcalc1->out;
	in1 = ionode->tonemuladd;
};

node tonemulcalc3 math::mul {
	in0 = tonemulcalc2->out;
	in1 = ionode->tonemuladd;
};

node tonemulcalc4 math::mul {
