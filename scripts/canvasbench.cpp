 ...
 * entire graph, and docs/VISUALIZERS.md says plainly that this measurement comes
 ...
 * describing the same scene twice is exactly how docs/NODE_EDITOR.md's "clicking
               ...
               Result &out)
{
     ...
     *
     * docs/NODE_EDITOR.md is right that the bugs that matter here are visual and
